...
public:
    ...
    void visualize(coord_t nozzle_size, bool output_toolpaths = false, bool output_widths = true, bool include_legend = false, bool output_accuracy = true, bool exaggerate_widths = false, bool rounded_visualization = true);
    void saveResultsCSV();
