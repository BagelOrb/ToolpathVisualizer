...
{
template <>
struct hash<visualizer::ClosestPolygonPoint>
{
    size_t operator()(const visualizer::ClosestPolygonPoint& cpp) const
    {
        return std::hash<visualizer::Point>()(cpp.p());
    }
};
}//namespace std
...
public:
    ...
    */
     ...
     * 
     * This implementation uses a sparse grid to get to an acvisualizerte result quickly
     * 
